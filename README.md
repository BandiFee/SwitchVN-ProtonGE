...
> [!Note]
> The usage and build documentation below is derived from the upstream GE-Proton documentation. SwitchVN releases use the `GE-Proton11-5-SwitchVN-2` build identifier, where the trailing number is the SwitchVN revision of that upstream base.
